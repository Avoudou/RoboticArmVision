...
public class ObjRecognition extends Application {
	 ...
	 * 
	 * This application looks for any tennis ball in the camera video stream and try
	 * to select them according to their HSV values. Found tennis balls are framed
	 * with a blue line.
	 * 
	...
	public void start(Stage primaryStage) {
		try {
			...
			// scene
			primaryStage.setTitle("Goalkeeper Vision Interface");
	...
	public void LaunchRec(String[] args) {
